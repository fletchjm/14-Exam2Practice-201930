...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        ac = additional_contents
        x = self.volume - len(self.contents)
        self.contents = self.contents + ac[:x]
        s = ac[x:]
        return s
    ...
    def double(self):
        ...
        self.contents = double[:self.volume]
        s = double[self.volume:]
        return s
    ...
    def steal(self, other_box):
        ...
        x = self.volume - len(self.contents)
        self.contents = self.contents + other_box.contents[:x]
        other_box.contents = other_box.contents[x:]
